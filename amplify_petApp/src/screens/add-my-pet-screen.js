...
export default function AddMyPetScreen({ updateAuthState }) {
						...
						<ScrollView>
							...
							<Picker
								...
								onValueChange={(itemValue, itemIndex) => setPetGender(itemValue)}>
									{/* {genderList} */}
									<Picker.Item label="Pet gender" value={null} />
									<Picker.Item label="Undecided" value="U" />
							...
							/>
							<TouchableOpacity onPress={addPetTest} style={styles.buttonContainer}>
